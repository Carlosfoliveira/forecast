...
model = MLPRegressor(hidden_layer_sizes=(100), activation='relu', solver='lbfgs', learning_rate='constant', 
                      learning_rate_init=0.01, alpha=0.01)       #Solver='adam' é o padrao mas serve para muitos dadosm lbfgs é melhor para poucos dados
