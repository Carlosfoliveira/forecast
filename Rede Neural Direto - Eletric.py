...
def createmodel(nPassos,previsaoNPassos,randomState):
    (trainset,traintarget,testset,testtarget,valorminimo,valormaximo) = processdata('eletric.txt',12,nPassos,previsaoNPassos)

    model = MLPRegressor(hidden_layer_sizes=(12), activation='logistic', solver='lbfgs', learning_rate='adaptive', 
